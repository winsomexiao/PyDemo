...
class Ui_Wins_Widget(object):
    def setupUi(self, Wins_Widget):
        ...
        self.page1.setGeometry(QtCore.QRect(0, 0, 166, 381))
        self.page1.setObjectName("page1")
        self.page1group = QtWidgets.QGroupBox(self.page1)
        self.page1group.setGeometry(QtCore.QRect(0, 0, 161, 381))
        self.page1group.setObjectName("page1group")
        self.verticalLayoutWidget_2 = QtWidgets.QWidget(self.page1group)
        self.verticalLayoutWidget_2.setGeometry(QtCore.QRect(10, 19, 141, 361))
        ...
        self.page2group.setGeometry(QtCore.QRect(10, 0, 151, 371))
        self.page2group.setObjectName("page2group")
        self.verticalLayoutWidget = QtWidgets.QWidget(self.page2group)
        self.verticalLayoutWidget.setGeometry(QtCore.QRect(0, 10, 141, 361))
        ...
        self.qryBtn = QtWidgets.QPushButton(self.gridLayoutWidget)
        ...
        self.centerLayout.setStretch(0, 2)
        self.centerLayout.setStretch(1, 8)
    ...
    def retranslateUi(self, Wins_Widget):
        ...
        self.page1group.setTitle(_translate("Wins_Widget", "GroupBox"))
        ...
        self.toolBox.setItemText(self.toolBox.indexOf(self.page1), _translate("Wins_Widget", "Page 1"))
        self.page2group.setTitle(_translate("Wins_Widget", "GroupBox"))
        ...
        self.toolBox.setItemText(self.toolBox.indexOf(self.page2), _translate("Wins_Widget", "Page 2"))
